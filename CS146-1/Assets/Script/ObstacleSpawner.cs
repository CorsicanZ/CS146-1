...
public class ObstacleSpawner : MonoBehaviour
{
    ...
    void generate_bunch_obstacles()
    {
        ...
        Instantiate(short_obstacle, new Vector3(x, 1, 90), Quaternion.identity);
        Instantiate(short_obstacle, new Vector3(x+3, 1, 90), Quaternion.identity);
        Instantiate(short_obstacle, new Vector3(x+6, 1, 90), Quaternion.identity);
    }

    void generate_huge_obstacle()
    {
        Instantiate(long_obstacle, new Vector3(Random.Range(-2.5f, 2.5f), 1, 90), Quaternion.identity);
    }
}
